...
const ProductDetail = ({ toggleModal, data, closeModal }) => {
                  ...
                  <div className="mt-3 md:mt-4 lg:mt-0 flex  flex-row items-stretch justify-center lg:space-x-8">
                    ...
                    <div className="w-1/2 flex flex-col justify-center mt-7 md:mt-8 lg:mt-0 pb-8 lg:pb-0">
                      ...
                      <p className="text-3xl font-medium text-gray-600 mt-8 md:mt-10">
                        {state.originalPrice.toLocaleString()} vnđ
                      </p>
                      <div className="flex items-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8 mt-8 md:mt-16">
                        <button className="w-full md:w-3/5 border border-gray-800 text-base font-medium leading-none uppercase py-6 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 bg-gray-800 text-white">
                          Add to Cart
                        </button>
                      </div>
                      <div className="mt-6">
