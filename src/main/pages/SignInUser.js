...
function SignInUser() {
  ...
  return (
    <div className="h-full bg-gradient-to-tl from-indigo-500 to-red-500 w-full pb-40 px-4">
      <div className="flex flex-col items-center justify-center">
        <Link to="/" className="my-10">
          <SiShopware className="text-5xl w-36" />
        ...
        <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-4">
          <p
            ...
            className="pb-10 text-2xl text-center font-extrabold leading-6 text-gray-800"
          >
            Sign In
          </p>
